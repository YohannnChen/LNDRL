...
class AmclNode
{
  ...
  private:
    ...
    bool getPoseCallback(comn_pkg::GetPose::Request& req,
                         comn_pkg::GetPose::Response& res);
        ...
        first_reconfigure_call_(true)
{
  ...
  get_pose_srv_ = nh_.advertiseService("/get_pose", &AmclNode::getPoseCallback, this);
...
bool 
AmclNode::getPoseCallback(comn_pkg::GetPose::Request& req,
                          comn_pkg::GetPose::Response& res)
{
  res.pose_with_cov = last_published_pose.pose;
  return true;
}
